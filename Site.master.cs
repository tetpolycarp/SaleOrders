...
public partial class SiteMaster : MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                SharedMethod.WriteLog("Anonymous loads this page: " + currentPage, "Desktop Master 1", SharedConstants.ACTIVITY_LOGS_FILE);
            }
            else
            {
                SharedMethod.WriteLog(HttpContext.Current.User.Identity.Name + " loads this page: " + currentPage, "Desktop Master 1", SharedConstants.ACTIVITY_LOGS_FILE);
            }
        }
        catch(Exception ex)
        {
