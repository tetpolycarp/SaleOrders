           ...
           <tr>
               <td>
                     ...
                     <table style="width: 100%;">
                         <tr>
                             <td  align="right">
                             <asp:Label ID="LabelCustomer" runat="server" Text="Customer Name" Enabled="false"></asp:Label>
                          ...
                          <tr><td  align="right">
                             <asp:Label ID="LabelPhoneNumber" runat="server" Text="Phone Number" Enabled="false"></asp:Label>
                  ...
                  <td>
                       <div id="div_print_pickupdate">
                         <table style="width: 100%;">      
                                       <tr>
                                 <td>
                                    <asp:Label ID="LabelInvoicePickupDate" runat="server" Text="Pickup Date " Enabled="false"></asp:Label></td>
                             ...
                             <td align="left">
                                 <asp:RadioButtonList ID="RadioButtonListInvoiceType" runat="server" Enabled="false" OnSelectedIndexChanged="RadioButtonListInvoiceType_SelectedIndexChanged1" AutoPostBack="true">
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                    ...
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                      ...
                      <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Sale Item" UniqueName="SaleItem" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="25%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:DropDownList ID="DropDownListSaleItem" Enabled="false" runat="server" AutoPostBack="false" OnSelectedIndexChanged="DropDownListSaleItem_SelectedIndexChanged" Font-Bold="True" Font-Size="Large" style="text-align: left" Width="80%"></asp:DropDownList>
                                    </ItemTemplate> 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                    ...
                    <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Quantity" UniqueName="Quantity" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:TextBox ID="TextBoxQuantity" Enabled="false" runat="server" AutoPostBack="false" OnTextChanged="TextBoxQuantity_TextChanged" Font-Bold="True" Font-Size="Large" style="text-align: right" Width="80%">
                                        </asp:TextBox>
                                    </ItemTemplate> 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                 ...
                 <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Discount Per Unit" UniqueName="Discount" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:TextBox ID="TextBoxDiscount" runat="server" Enabled="false" AutoPostBack="false" OnTextChanged="TextBoxDiscount_TextChanged" Font-Bold="True" Font-Size="Large" style="text-align: right" Width="80%">
                                        </asp:TextBox>
                                    </ItemTemplate> 
